...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Large Banner') }} </h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-ps-page-banner') }}">{{ __('Large Banner') }} </a>
                        </li>
                      </ul>
                  </div>
                </div>
                      ...
                      <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                <div class="col-lg-4">
                                  <div class="left-area">
                                    ...
                                    <small>{{ __('(Preferred SIze: 1920 X 480 Pixel)') }}</small>
                                  </div>
                                </div>
                                <div class="col-lg-7">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-7">
                                  <input type="text" class="input-field" name="big_save_banner_subtitle" placeholder="{{ __('Subtitle') }}" required="" value="{{ $data->big_save_banner_subtitle }}">
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-7">
                                  <input type="text" class="input-field" name="big_save_banner_title" placeholder="{{ __('Title') }}" required="" value="{{ $data->big_save_banner_title }}">
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-7">
                                  <input type="text" class="input-field" name="big_save_banner_text" placeholder="{{ __('Text') }}" required="" value="{{ $data->big_save_banner_text }}">
                                </div>
                              </div>
